...
namespace dxvk::util {
  ...
  #define MAP_OBJECT_TYPE(vk_type, vk_enum) inline VkObjectType getVulkanObjectType(vk_type) { return vk_enum; }
  MAP_OBJECT_TYPE(VkInstance, VK_OBJECT_TYPE_INSTANCE)
  MAP_OBJECT_TYPE(VkPhysicalDevice, VK_OBJECT_TYPE_PHYSICAL_DEVICE)
  MAP_OBJECT_TYPE(VkQueue, VK_OBJECT_TYPE_QUEUE)
  MAP_OBJECT_TYPE(VkSemaphore, VK_OBJECT_TYPE_SEMAPHORE)
  MAP_OBJECT_TYPE(VkCommandBuffer, VK_OBJECT_TYPE_COMMAND_BUFFER)
  MAP_OBJECT_TYPE(VkFence, VK_OBJECT_TYPE_FENCE)
  MAP_OBJECT_TYPE(VkDeviceMemory, VK_OBJECT_TYPE_DEVICE_MEMORY)
  MAP_OBJECT_TYPE(VkBuffer, VK_OBJECT_TYPE_BUFFER)
  MAP_OBJECT_TYPE(VkImage, VK_OBJECT_TYPE_IMAGE)
  MAP_OBJECT_TYPE(VkEvent, VK_OBJECT_TYPE_EVENT)
  MAP_OBJECT_TYPE(VkQueryPool, VK_OBJECT_TYPE_QUERY_POOL)
  MAP_OBJECT_TYPE(VkBufferView, VK_OBJECT_TYPE_BUFFER_VIEW)
  MAP_OBJECT_TYPE(VkImageView, VK_OBJECT_TYPE_IMAGE_VIEW)
  MAP_OBJECT_TYPE(VkShaderModule, VK_OBJECT_TYPE_SHADER_MODULE)
  MAP_OBJECT_TYPE(VkPipelineCache, VK_OBJECT_TYPE_PIPELINE_CACHE)
  MAP_OBJECT_TYPE(VkPipelineLayout, VK_OBJECT_TYPE_PIPELINE_LAYOUT)
  MAP_OBJECT_TYPE(VkRenderPass, VK_OBJECT_TYPE_RENDER_PASS)
  MAP_OBJECT_TYPE(VkPipeline, VK_OBJECT_TYPE_PIPELINE)
  MAP_OBJECT_TYPE(VkDescriptorSetLayout, VK_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT)
  MAP_OBJECT_TYPE(VkSampler, VK_OBJECT_TYPE_SAMPLER)
  MAP_OBJECT_TYPE(VkDescriptorPool, VK_OBJECT_TYPE_DESCRIPTOR_POOL)
  MAP_OBJECT_TYPE(VkDescriptorSet, VK_OBJECT_TYPE_DESCRIPTOR_SET)
  MAP_OBJECT_TYPE(VkFramebuffer, VK_OBJECT_TYPE_FRAMEBUFFER)
  MAP_OBJECT_TYPE(VkCommandPool, VK_OBJECT_TYPE_COMMAND_POOL)
  MAP_OBJECT_TYPE(VkDescriptorUpdateTemplate, VK_OBJECT_TYPE_DESCRIPTOR_UPDATE_TEMPLATE)
  MAP_OBJECT_TYPE(VkSurfaceKHR, VK_OBJECT_TYPE_SURFACE_KHR)
  MAP_OBJECT_TYPE(VkSwapchainKHR, VK_OBJECT_TYPE_SWAPCHAIN_KHR)
  #undef MAP_OBJECT_TYPE
  #else
  template<typename T>
  VkObjectType getVulkanObjectType(T) { return VK_OBJECT_TYPE_UNKNOWN; }
  #endif
